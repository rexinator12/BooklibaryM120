...
class Login extends dbh {
    //getUser wird ausgerufen und die daten werden getestet
    ...
    elseif($checkPassword ==true){
        ...
        session_start();
        //hier werden wichtige daten in session gespeichert, damit website weiss, ob jemand eingeloggt ist oder nicht
