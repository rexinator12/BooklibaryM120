      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
             <!-- Daten werden mit post methode weitergeleitet -->
            <div class="mb-md-5 mt-md-4 pb-5">
              <form action="Controller/register.inc.php" method="post">
              ...
              <div class="form-outline form-white mb-4">
                <input type="password" name="reppassword" class="form-control form-control-lg" />
                <label class="form-label" for="reppassword">Repeat Password</label>
              </div>


              <button class="btn btn-outline-light btn-lg px-5" type="submit" name="submit">Regist</button>
